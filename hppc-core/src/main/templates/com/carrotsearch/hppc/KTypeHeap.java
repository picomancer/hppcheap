...
`     */
     ...
     */
    public KTypeHeap(int initialCapacity)
    {
        ...
        {
            System.err.println("hppc:  Heap classes are still considered experimental, use at own risk.  Set "+KTypeHeap.class+".experimental_warning = false to suppress this message.");
     ...
     */
    public KTypeHeap(KTypeContainer<KType> container)
    {
        this((int) (container.size()));
     ...
     * This behavior may change in future releases.
     */
    public static class _Iterator
        extends AbstractIterator<KTypeCursor<KType>>
    {
        public KTypeHeap heap;
        public KTypeCursor<KType> cursor;

        public _Iterator(KTypeHeap heap)
        {
            this.heap = heap;
